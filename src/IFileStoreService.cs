...
namespace aFile
{
    ...
    public interface IFileStoreService
    {
        ...
        IEnumerable<T> RreadAll<T>() where T : class;
        ...
        T ReadSingle<T>(string id) where T : class;
        ...
        /// </remarks>
        void Insert<T>(T value, string id) where T : class;
        ...
        /// </remarks>
        void Update<T>(T value, string id) where T : class;
